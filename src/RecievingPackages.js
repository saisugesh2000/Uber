...
const RecievingPackages = () => {
  ...
  const todoRef = firebase.firestore().collection('rvcData');
    ...
    <View style={Globalstyle.container}>
      ...
      <View style={Globalstyle.headerContainer}>
        ...
        <Feather name="arrow-left" size={26} color="#979797" />
          ...
          <Image
        source={require('../assets/Images/contact.png')}/><Text style={Globalstyle.iconInfo}>Contacts</Text>
          </TouchableOpacity>
        </View>
        <View style={Globalstyle.cntalin}>
          <Text style={Globalstyle.heading}>Who’s recieving the package?</Text>
          <Text style={Globalstyle.rvcsecondtxt}>The driver may contact the reciever to compete the delivery</Text>
